...
<div style="display: flex; gap: 20px; margin: 30px 0;">
  <div style="flex: 1; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; border-radius: 12px; color: white; border: 2px solid rgba(255,255,255,0.2);">
  ...
  <div style="flex: 1; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); padding: 30px; border-radius: 12px; color: white; border: 2px solid rgba(255,255,255,0.2);">
...
<div style="display: flex; gap: 15px; margin: 20px 0; flex-wrap: wrap;">
  <div style="flex: 1; min-width: 200px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 20px; border-radius: 12px; color: white; border: 2px solid rgba(255,255,255,0.15);">
  ...
  <div style="flex: 1; min-width: 200px; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); padding: 20px; border-radius: 12px; color: white; border: 2px solid rgba(255,255,255,0.15);">
  ...
  <div style="flex: 1; min-width: 200px; background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); padding: 20px; border-radius: 12px; color: white; border: 2px solid rgba(255,255,255,0.15);">
...
<div style="display: flex; gap: 15px; margin: 20px 0; flex-wrap: wrap;">
  <div style="flex: 1; min-width: 160px; background: rgba(30, 30, 30, 0.05); padding: 15px; border-radius: 8px; border: 1px solid rgba(102, 126, 234, 0.3);">
...
<div style="display: flex; gap: 15px; margin: 20px 0;">
  <div style="flex: 1; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 20px; border-radius: 12px; color: white; border: 2px solid rgba(255,255,255,0.15);">
  ...
  <div style="flex: 1; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); padding: 20px; border-radius: 12px; color: white; border: 2px solid rgba(255,255,255,0.15);">
...
<div style="display: flex; gap: 15px; margin: 20px 0; flex-wrap: wrap;">
  <div style="flex: 1; min-width: 160px; background: #f0f4ff; padding: 15px; border-radius: 8px; border: 1px solid #667eea;">
    <strong>📈 <a href="dev/sai-keeper/api-perp.md">Perp API</a></strong>
    <p style="margin: 5px 0 0 0; font-size: 13px;">Query perpetual positions and market data</p>
  </div>
  
  <div style="flex: 1; min-width: 160px; background: #f0f4ff; padding: 15px; border-radius: 8px; border: 1px solid #667eea;">
    <strong>💰 <a href="dev/sai-keeper/api-lp.md">LP API</a></strong>
    <p style="margin: 5px 0 0 0; font-size: 13px;">Liquidity provider positions and data</p>
  </div>
  
  <div style="flex: 1; min-width: 160px; background: #ffe6f0; padding: 15px; border-radius: 8px; border: 1px solid #f093fb;">
    <strong>🔮 <a href="dev/sai-keeper/api-oracle.md">Oracle API</a></strong>
    <p style="margin: 5px 0 0 0; font-size: 13px;">Price feeds and oracle information</p>
  </div>
  
  <div style="flex: 1; min-width: 160px; background: #ffe6f0; padding: 15px; border-radius: 8px; border: 1px solid #f093fb;">
    <strong>💳 <a href="dev/sai-keeper/api-fees.md">Fees API</a></strong>
    <p style="margin: 5px 0 0 0; font-size: 13px;">Fee structures and calculations</p>
  </div>
</div>
...
<div style="display: flex; gap: 15px; margin: 20px 0;">
  <div style="flex: 1; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); padding: 20px; border-radius: 12px; color: white; border: 2px solid rgba(255,255,255,0.15);">
  ...
  <div style="flex: 1; background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); padding: 20px; border-radius: 12px; color: #333; border: 2px solid rgba(255,255,255,0.15);">
...
<div style="background: rgba(200, 200, 200, 0.1); padding: 15px; border-radius: 8px; margin: 20px 0; border: 1px solid rgba(100, 100, 100, 0.2);">
...
<div style="display: flex; gap: 15px; margin: 20px 0; flex-wrap: wrap;">
  <div style="flex: 1; min-width: 180px; background: #f0f8ff; padding: 20px; border-radius: 8px; border: 1px solid #667eea;">
  ...
  <div style="flex: 1; min-width: 180px; background: #fff0f8; padding: 20px; border-radius: 8px; border: 1px solid #f093fb;">
    <strong>🐛 Bug Report?</strong>
    <p style="margin: 10px 0 0 0; font-size: 14px;">Open an issue on our <strong>GitHub repository</strong></p>
  </div>
  
  <div style="flex: 1; min-width: 180px; background: #f0fff0; padding: 20px; border-radius: 8px; border: 1px solid #4facfe;">
...
<div style="text-align: center; margin: 40px 0; padding: 30px; background: linear-gradient(135deg, rgba(102, 126, 234, 0.1) 0%, rgba(240, 147, 251, 0.1) 100%); border-radius: 12px; border: 2px solid rgba(102, 126, 234, 0.3);">
